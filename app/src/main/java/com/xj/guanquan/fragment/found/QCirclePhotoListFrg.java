...
import com.xj.guanquan.fragment.roast.MoveLineView;
 ...
 */
public class QCirclePhotoListFrg extends QBaseFragment {
    ...
    public static QCirclePhotoListFrg newInstance(int PageType) {
        QCirclePhotoListFrg fragment = new QCirclePhotoListFrg();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_qcircle_photo_list, container, false);
