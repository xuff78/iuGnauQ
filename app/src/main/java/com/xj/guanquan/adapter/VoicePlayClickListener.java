...
//			voiceIconView.setImageResource(R.drawable.chatto_voice_playing);
		...
		isPlaying = false;
		((QMsgDetailActivity) activity).playMsgId = null;
	...
	public void playVoice(String filePath) {
		...
		((QMsgDetailActivity) activity).playMsgId = message.getMsgId();
		AudioManager audioManager = (AudioManager) activity.getSystemService(Context.AUDIO_SERVICE);

		mediaPlayer = new MediaPlayer();
		if (true){//HXSDKHelper.getInstance().getModel().getSettingMsgSpeaker()) {
...
//			voiceIconView.setImageResource(R.anim.voice_to_icon);
	...
	public void onClick(View v) {
		...
		if (isPlaying) {
			if (((QMsgDetailActivity) activity).playMsgId != null && ((QMsgDetailActivity) activity).playMsgId.equals(message.getMsgId())) {
