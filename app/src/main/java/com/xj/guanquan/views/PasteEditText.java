...
//            if(text.startsWith(QMsgDetailActivity.COPY_IMAGE)){
//                intent.setDataAndType(Uri.fromFile(new File("/sdcard/mn1.jpg")), "image/*");
//                text = text.replace(QMsgDetailActivity.COPY_IMAGE, "");
...
//                ((Activity)context).startActivityForResult(intent,QMsgDetailActivity.REQUEST_CODE_COPY_AND_PASTE);
//                clip.setText("");
//            }
        }
