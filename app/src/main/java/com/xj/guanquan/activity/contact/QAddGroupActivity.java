...
public class QAddGroupActivity extends QBaseActivity implements View.OnClickListener {

    private SearchView searchView;
    private RecyclerView searchHidstoryView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qadd_group);
    }

    @Override
    protected void initView() {
        _setHeaderTitle(getString(R.string.title_activity_qadd_group));
        _setRightHomeGone();
        initialize();
    ...
    private void initialize() {
        ...
        searchHidstoryView = (RecyclerView) findViewById(R.id.searchHidstoryView);
