...
public class QVisitorListActivity extends QBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qblack_list);
    }

    @Override
    protected void initView() {
        initialize();
        _setHeaderTitle(getString(R.string.title_activity_qvisitor_list));
        _setRightHomeGone();
        _setRightHomeText("移除", new View.OnClickListener() {
            @Override
...
//        userInfoList.add(new UserInfo("孔先生", "http://www.feizl.com/upload2007/2014_09/14090118321004.jpg", " ♂ ", 23, "爱音乐，爱疯尚，爱就是一支的追求", "30min", "25mk"));
    ...
    private void initialize() {
        blackListView = (RecyclerView) findViewById(R.id.blackListView);
